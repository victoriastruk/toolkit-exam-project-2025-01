...
import styles from './MainMenuDesktop.module.sass';
      ...
      <ul className={styles.mainMenu}>
        <li>
          ...
          <div className={styles.subMenu}>
            ...
            <PromoCard
              backgroundImage={`${STATIC_IMAGES_PATH}get_started_bg.svg`}
            ...
            <ul className={styles.mainLeftLinks}>
              ...
              <li>
                <SubMenuItem
                  ...
                  icon={`${STATIC_IMAGES_PATH}atom_radar.svg`}
                  title="AtomRadar"
