...
export const getOffers = ({limit, offset}) => http.get('offers', {params:{limit, offset}});
export const moderateOffer = (data) => http.post('moderateOffer', data);
...
export const getCustomersContests = (data) => http.post(
